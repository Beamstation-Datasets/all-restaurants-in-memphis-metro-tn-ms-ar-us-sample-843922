# All Restaurants in Memphis (Metro), TN-MS-AR, US
...
| Full dataset size | 2,577 records |
| Free sample size | 257 records (9.97%) |
| Last export | 2026-04-21T21:02:48.091228+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-memphis-metro-tn-ms-ar-us-sample-843922/releases/download/sample-latest/beamstation_843922_restaurants-us-memphistnmsar_SAMPLE_DIST.csv) |
...
Search for dataset ID `843922` on BeamStation if you want the exact commercial listing.
